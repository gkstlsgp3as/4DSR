...
def rimg_inference(rimg_file_list, output_directory, check_point_pth) : #inference 
    ...
    for rimg_file in tqdm(rimg_file_list, file = sys.stdout) :
            ...
            lidar_out['channels'] = 1920
            lidar_out['points_per_ring'] = 1080
...
if __name__ == '__main__':
    ...
    rimg_file_list_origin = sorted(glob.glob('./rimg_dataset/4DSR/Lidar_sr_data/384_216_origin/test/*.rimg'))
    rimg_file_list_downsample = sorted(glob.glob('./rimg_dataset/4DSR/Lidar_sr_data/384_216_downsample/test/*.rimg'))
    
    output_directory_origin = './inference/rimg/origin_retina_384_1920/'
    output_directory_downsample = './inference/rimg/downsample_retina_384_1920/'

    output_pcd_dir_origin = './inference/pcd/origin_retina_384_1920/'
    output_pcd_dir_downsample = './inference/pcd/downsample_retina_384_1920/'

    denoise_rimg_origin = './inference/rimg/denoise/origin_retina_384_1920/'
    denoise_rimg_downsample = './inference/rimg/denoise/downsample_retina_384_1920/'

    check_point_pth = glob.glob('./models/trained/iln_4dsr/*best.pth')  
