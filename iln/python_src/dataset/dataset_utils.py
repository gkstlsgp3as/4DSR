...
def read_range_image_binary(filename, dtype=np.float16, lidar=None):
    ...
    # print('size', size)
    # print('size', size)
    # size2= np.fromfile(range_image_file, dtype=np.uint, count=4)
    ...
    # if range_image.shape/(32*1024)>1:
    #     range_image = range_image.reshape(size[1],32) ###
    # else:
    #     range_image = range_image.reshape(size[1],32) ###
    #print('range_image.shape:',range_image.shape)
    #print('size:',size)
    range_image = range_image.reshape(size[1],size[0]) 
    # print('***rimg shape:',range_image.shape)
...
def read_range_image_mat(filename, dtype=np.float16, lidar=None):
    """
    Read a range image from a binary file.
