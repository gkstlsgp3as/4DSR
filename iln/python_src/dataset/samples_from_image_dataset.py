...
class SamplesFromImageDataset(RangeImagesDataset):
    def __init__(self, train, directory, scene_ids, res_in, res_out, num_of_samples=0, memory_fetch=True):
        """
        ...
        """
        super(SamplesFromImageDataset, self).__init__(train, directory, scene_ids, res_in, res_out, memory_fetch)
