...
train_output_path_128 = './rimg_dataset/Custom_2/Lidar_sr_data/128_1024_origin2/train/'
train_output_path_origin_32 = './rimg_dataset/Custom_2/Lidar_sr_data/32_1024_downsample2/train/'
train_output_path_downsaple_32 = './rimg_dataset/Custom_2/Lidar_sr_data/32_1024_downsample/train/'

valid_output_path_128 = './rimg_dataset/Custom_2/Lidar_sr_data/128_1024_origin2/valid/'
valid_output_path_origin_32 = './rimg_dataset/Custom_2/Lidar_sr_data/32_1024_downsample2/valid/'
...
def read_pcd():
    ...
    file_list_train_128 = sorted(glob.glob('../../super_resolution_data/Training/01.원천데이터/TS_수집차량_2_lidar_H/*.pcd'))
    file_list_train_32 = sorted(glob.glob('../../super_resolution_data/Training/01.원천데이터/TS_수집차량_2_lidar_L/*.pcd'))

    #for i in valid_dir_num : 
    file_list_valid_128 = sorted(glob.glob('../../super_resolution_data/Validation/01.원천데이터/TS_수집차량_2_lidar_H/*.pcd'))
    file_list_valid_32 = sorted(glob.glob('../../super_resolution_data/Validation/01.원천데이터/TS_수집차량_2_lidar_L/*.pcd'))
