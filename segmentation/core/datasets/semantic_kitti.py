...
class SemanticKITTI(dict):
    ...
    def __init__(self, root, voxel_size, num_points, label_name_mapping, kept_labels, seqs, **kwargs):
...
class SemanticKITTIInternal:
    ...
    def __init__(self,
        ...
        self.angle = 0.0
        self.eee=''
        print(self.reverse_label_name_mapping)
    ...
    def __getitem__(self, index):
        with open(self.files[index], 'rb') as b:
            print("\n trained data = {}".format(self.files[index]))
        while True:
            try:
                with open(self.files[index], 'rb') as b:
